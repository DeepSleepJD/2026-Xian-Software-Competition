...
- [ ] **P4（当前最高优先）**：2026-07-02 现网两连败（60/80 vs 727/753，日志 `looog/`）——对手在 S10 咽喉设卡钉死我方 ~190 帧、窗口出牌全弃权、资源全没用。对抗层从加分项变成活命项。**改动清单见 `docs/P4-对抗层改动清单.md`**（败因证据 + 规则依据 + 分优先级改动项 + 验证方案，自包含可直接交给实施 agent）
